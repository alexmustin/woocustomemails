...
https://github.com/alexmustin/woocustomemails/issues/
...
1. Plugin menu: "Custom Emails"
2. 'Custom Message' example - use the Classic Editor
3. New Tab in the WooCommerce Product Data section: "Custom Emails"
4. Use the search fields to find your WCE Message, then assign it to an Order Status email. Click the Title of your Message to assign it, then Update/Publish the Product to save your settings.
...
= 2.2.1 - (Dec 27, 2018) =
* UPDATE: Compatible with WordPress 5.02 and WooCommerce 3.5.3
